...
public class reproductor_video extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = ProgressDialog.show(reproductor_video.this, "", "Cargando video...", true);
    ...
    private void PlayVideo() {
        try {
            ...
            MediaController mediaController = new MediaController(reproductor_video.this);
